...
export default function JsonFormatterTool() {
  ...
  return (
    ...
    //    <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm 
        // hover:shadow-md dark:border-gray-700 dark:bg-gray-800 transition-all duration-300">
    ...
    rounded-xl border border-gray-200 bg-white shadow-sm hover:shadow-md dark:border-gray-700 dark:bg-gray-800 transition-all duration-300">
      <div className="">
        <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200">JSON Formatter</h3>

        <label htmlFor="json-input" className="block mt-1 text-sm font-medium text-gray-600 dark:text-gray-400">
      ...
      <div>
        <h4 className="text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2">Formatted output</h4>
